...
import skuuz.communication.SocketOperator;
import skuuz.interfaces.IAppManager;
import skuuz.interfaces.ISocketOperator;
import skuuz.interfaces.IUpdateData;
import skuuz.tools.FriendController;
import skuuz.tools.LocalStorageHandler;
import skuuz.tools.MessageController;
import skuuz.tools.XMLHandler;
import skuuz.types.FriendInfo;
import skuuz.types.MessageInfo;
import skuuz.ui.Login;
import skuuz.ui.Messaging;
import skuuz.ui.R;
...
*/	
	...
	public String authenticateUser(String usernameText, String passwordText) throws UnsupportedEncodingException 
	{
		...
		if (result != null && !result.equals(Login.rslt)) 
		{			
	...
	public String signUpUser(String usernameText, String passwordText,String name,String phone,String gender,
			String emailText,String longitude,String latitude) 
	{
